...
export const HTML_ELEMENT = {
  ...
  CHAT_POPOVER: {
    ...
    CHAT_MUTE: 'div:nth-child(1) > chat-conversation-item-with-menu > chat-slide-menu > div > div:nth-child(2) > chat-conversation-menu > article > section:nth-child(3) > button > span',
    CHAT_ADD_PARTICIPANT: 'span.scc-ui-font.scc-ui-icon-mock-more-contact',
    CHAT_NAME_CONVERSATION: 'label.scc-ui-no-margin.scc-ui-txt-ellipsis.chat-icon-detail-link-text-right.chat-icon-detail-clickable',
    CHAT_ADD_PARTICIPANT1: 'span.scc-ui-font.scc-ui-font-1x.scc-ui-icon-mock-profile-information-1.chat-conversation-participants-panel-icon',
